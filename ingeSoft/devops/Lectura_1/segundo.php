...
if ($_POST) {
   ...
   if ($respuesta_10 === 'Coordinacion externa') {  
   ...
   if ($respuesta_11 === 'Prioridades') {  
    ...
    if ($respuesta_15 === 'Reliability Engineer') { 
    ...
    if ($respuesta_18 === 'disponibilidad') {  
    ...
    if ($respuesta_19 === 'Analisis rapido') {  
   ...
   if ($respuesta_27 === 'DevOps Engineer') {  
   ...
   if ($respuesta_28 === 'Herramientas DevOps') {  
   ...
   if ($respuesta_31 === 'Automatizacion') {  
   ...
   if ($respuesta_33 === 'Indirecta') {  
    ...
    if ($respuesta_45 === 'responsabilidades') { 
...
if ($respuesta_54 === 'Cultura organizacional') { 
...
if ($respuesta_55 === 'cambiar rapido') { 
...
if ($respuesta_57 === 'Silos organizacionales') { 
...
if ($respuesta_59 === 'responsabilidades') { 
...
if ($respuesta_61 === 'Diferentes incentivos') { 
...
if ($respuesta_63 === 'entregar funcionalidades') { 
...
if ($respuesta_64 === 'Evitar cambios') { 
...
if ($respuesta_67 === 'conocimiento especializado') { 
...
if ($respuesta_69 === 'procesos comunes') { 
...
if ($respuesta_74 === 'aumentar costos') { 
...
if ($respuesta_75 === 'desarrolladores') { 
...
if ($respuesta_77 === 'automatizacion') { 
...
if ($respuesta_80 === 'automatizacion') { 
...
if ($respuesta_81 === 'tiempo') { 
    ...
    if ($respuesta_87 === 'responsabilidades') { 
    ...
    if ($respuesta_88 === 'desarrolladores') { 
...
<h3>7. Roles en un equipo DevOps</h3>
...
<h4>Los 5 Porqués (<em>5 Whys</em>)</h4>

<pre>
¿Por qué el sistema está lento?
→ Mucha carga

¿Por qué hubo mucha carga?
→ Aumento inesperado de usuarios

¿Por qué no se detectó?
→ Las pruebas no tenían ese escenario
</pre>
...
<hr>
<h3>8. Coordinación en DevOps</h3>
...
<td>Personas que se conocen coordinan.</td>
</tr>
...
<td>Dirigida a un grupo definido.</td>
</tr>
...
<td>Queda evidencia como documentos o emails.</td>
</tr>
...
<td>No deja artefactos, como reuniones.</td>
</tr>
...
<td>Ocurre de manera diferida.</td>
</tr>
</table>
...
<h3>9. Coordinación entre equipos</h3>
...
<hr>
<h3>11. Principales trade-offs de DevOps</h3>
...
<hr>
<h3>Resumen de examen</h3>

<ol>
    <li>Definición exacta de DevOps.</li>
    <li>Reducir tiempo entre cambio y producción manteniendo calidad.</li>
    <li>Las cinco prácticas DevOps.</li>
    <li>Continuous Integration vs Continuous Deployment.</li>
    <li>Infrastructure as Code.</li>
    <li>Roles DevOps principales.</li>
    <li>Diferencia entre Desarrollo y Operaciones tradicional.</li>
    <li>Tipos de coordinación.</li>
    <li>Barreras culturales y silos.</li>
    <li>Automatización como elemento central de DevOps.</li>
</ol>
             <hr>
