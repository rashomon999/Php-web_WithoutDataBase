...
<div class="seccion izquierda"> 
     ...
     <h3>18. El Controller llama al Service</h3>
    ...
    <pre><code>const user =
    await userService.findById(id);</code></pre>

    <p>
        El controller llama al service:
    </p>

    <pre><code>userController.getOne()
        ↓
userService.findById()</code></pre>


    <h3>19. findById() llama al Model</h3>

    <p>
        En el service tenemos:
    </p>

    <pre><code>public findById(
    id: string
...
MongoDB</code></pre>
    ...
    <p>
        MongoDB busca el usuario utilizando su ID.
    </p>


    <h3>20. MongoDB devuelve el usuario</h3>
...
const user</code></pre>
    ...
    <h3>21. El Controller recibe el usuario</h3>
    ...
    <p>
        ahora contiene el usuario encontrado.
    </p>


    <h3>22. Comprueba si existe</h3>
    ...
    <p>
        Si MongoDB no encuentra el usuario:
    </p>
...
404 User not found</code></pre>
    ...
    <h3>23. Finalmente responde al cliente</h3>
    ...
    <p>
        El cliente recibe algo parecido a:
    </p>
...
<div class="seccion derecha">
        <h3>25. La idea fundamental</h3>

    <p>
        El login genera el JWT:
    </p>
...
genera JWT
       ↓
cliente recibe JWT</code></pre>

    <p>
        Después <code>/profile</code> utiliza ese JWT:
    </p>
...
busca ID en MongoDB
       ↓
devuelve usuario</code></pre>


    <h3>26. El papel de auth</h3>

    <p>
        Por eso <code>auth</code> está entre la ruta y el controller:
    </p>
...
MongoDB</code></pre>
    ...
    <p>
        Y <code>next()</code> es lo que permite que la petición pase
        de <code>auth</code> a <code>userController.getOne</code>.
    </p>
