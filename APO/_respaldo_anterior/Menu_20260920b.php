...
$SECCIONES = [
    [
        ...
        'desc' => 'Los cuatro cuestionarios encadenados de siempre: cargar y explorar, referenciar, filtrar y limpiar, y graficas.',
        'meta' => '4 cuestionarios · 125 huecos + 22 preguntas',
    ...
    [
        ...
        'meta' => '63 huecos + 11 preguntas',
        'src'  => 'Python material regresion MULTIPLE - POLINOMIAL-20260918/ — Sesion3-2-multiple-polinomial.ipynb'
    ],
    [
        'n'    => '9',
        ...
        'desc' => 'Las 39 preguntas unicas que quedan tras descartar los duplicados de los tres PDF de parciales: conceptos de EDA y ML, CRISP-DM, casos con datos (heladeria y automoviles), eleccion de metrica segun el negocio, regularizacion L1/L2, KNN y lectura de la matriz de confusion.',
        'meta' => '39 preguntas — 37 de opcion multiple, 1 de seleccion multiple y 1 de ordenar',
        'src'  => 'parciales/ — Examen parcial 1 (2025-B y 2025-2)'
    ],
];
?><!DOCTYPE html>
<html lang="es">
...
.tag.parcial{background:#fdecea;color:#c0392b}
</style>
</head>
<body>
...
<div class="wrap">
  ...
  <div class="intro">
    <p>Siete bloques: uno de <b>codigo</b> (pandas, con su propio submenu de cuatro cuestionarios),
       cuatro de <b>lecturas</b> del curso, uno <b>mixto</b> (regresion, que mezcla concepto y
       nombres de pandas) y el <b>repaso del parcial 1</b>, con las preguntas de examenes
       anteriores sin repetir. Cada hueco se corrige solo al pulsar
