...
<p>✅ <strong>Objetivo:</strong> Encontrar la integral de la secante:</p>
<p>\[ \int \sec(x) \, dx \]</p>

<p>✅ <strong>Idea clave:</strong><br>
No es un truco inventado por el profesor, sino una técnica clásica que ya resolvieron matemáticos del pasado.</p>

<p>✅ <strong>Estrategia:</strong><br>
Multiplicar y dividir por \( \sec(x) + \tan(x) \):<br>
\[
\int \sec(x) \, dx = \int \frac{\sec(x) (\sec(x) + \tan(x))}{\sec(x) + \tan(x)} \, dx
\]</p>

<p>El numerador se convierte en:<br>
\[
...
<p>\( \Longrightarrow \) El numerador es exactamente la derivada del denominador.</p>

<p>✅ <strong>Sustitución:</strong><br>
\( u = \sec(x) + \tan(x) \quad \Longrightarrow \quad du = [\sec^2(x) + \sec(x)\tan(x)]\, dx \)</p>

<p>Entonces:<br>
\[
\int \sec(x) \, dx = \int \frac{du}{u} = \ln|u| + C
\]</p>
...
<div class="seccion derecha">
 <p>✅ <strong>Objetivo:</strong> Encontrar la integral de la cosecante:</p>
<p>\[ \int \csc(x)\,dx \]</p>

<p>✅ <strong>Idea clave:</strong><br>
No es un método inventado ahora — es una técnica clásica que se aprende de libros porque no es tan directa.</p>

<p>✅ <strong>Estrategia:</strong><br>
1️⃣ Multiplicar y dividir por \( \csc(x) - \cot(x) \):<br>
\[
\int \csc(x)\,dx = \int \frac{ \csc(x)\,[\,\csc(x) - \cot(x)\,] }{ \csc(x) - \cot(x) }\,dx
\]</p>

<p>2️⃣ El numerador queda:<br>
\[
\csc(x)\,[\,\csc(x) - \cot(x)\,] = \csc^2(x) - \csc(x)\cot(x)
\]</p>

<p>3️⃣ Verifica la derivada:<br>
\[
...
<p>✅ <strong>Sustitución:</strong><br>
\( u = \csc(x) - \cot(x) \quad \Longrightarrow \quad du = [\,\csc^2(x) - \csc(x)\cot(x)\,]\,dx \)</p>

<p>✅ <strong>Resultado:</strong><br>
\[
\int \csc(x)\,dx = \int \frac{du}{u} = \ln|u| + C
\]<br>
Volviendo a la variable original:<br>
\[
